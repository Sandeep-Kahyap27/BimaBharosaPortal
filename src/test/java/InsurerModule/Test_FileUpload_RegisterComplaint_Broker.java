...
public class Test_FileUpload_RegisterComplaint_Broker extends MainClass {
    ...
    public void test_fileUpload_regComplaint_Agent() throws IOException {
        ...
        e.setComplaintAgainstTypeId(ExcelFileConstants.NEW_NONLIFE, ComplaintAgainstTypeConstants.BROKER, 4);
        e.setComplaintDetails(ExcelFileConstants.NEW_NONLIFE, "Register complaint against Broker through file upload", 4);

        e.setBrokerLicenseNumber(ExcelFileConstants.NEW_NONLIFE, "B317", 4);
        ...
        if (up.verifySuccessMsg()) {
            test.log(Status.PASS, "Complaint registered against Broker through file upload");
            logger.info("Test Passed : Complaint registered against Broker through file upload");
        } else {
        ...
        e.setBrokerLicenseNumber(ExcelFileConstants.NEW_NONLIFE, "NIL", 4);
