...
public class Test_FileUpload_RegisterComplaint_NonLife extends MainClass {
    ...
    //Author : Abhishek
    @Test
    public void test_fileUpload_regComplaint_NonLife() throws IOException, InterruptedException {

        test = extent.createTest("Positive : Verify complaint registered against Non-Life Insurance company through file upload");
        ...
        e.setComplaintDetails(ExcelFileConstants.NEW_NONLIFE, "Register complaint against Non-Life Insurance company through file upload",4);
        ...
        if(up.verifySuccessMsg()){
            test.log(Status.PASS, "Complaint registered against Non-Life Insurance company through file upload");
            logger.info("Test Passed : Complaint registered against Non-Life Insurance company through file upload");
        }
        else{
