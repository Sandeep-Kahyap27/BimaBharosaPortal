...
public class Test_CallCenterRegistration_VIP_PolicyHolder extends MainClass {

    @Test(dataProvider = "Call_Center_Register", dataProviderClass = DataReader.class)
    public void test_callCenter_registration_VIP_policyHolder(String identifyBy, String mob, String pinCode, String compAgainst, String insCompany, String policyType, String complaintType, String complaintDescType, String policyNumber, String complaintDetails, String source, String priority, String TAT, String priority_handling_details, String remarks) throws IOException, InterruptedException {

        test = extent.createTest("Positive: Verify call center user is able to register complaint for VIP policy holder with specified TAT days");
        ...
        cr.selectPriorityHandling(priority);
        cr.enterTATDays(TAT);
        cr.enterPriorityHandlingDetails(priority_handling_details);
        cr.enterRemarks(remarks);
        cr.clickOnRegister();
        ...
        if(msg != null && msg.equals("Complaint Registered Successfully.")){
            test.log(Status.PASS, "Complaint registered for VIP policy holder with specified TAT Days");
            logger.info("Test Passed : Complaint registered for VIP policy holder with specified TAT Days");
        }
        else{
