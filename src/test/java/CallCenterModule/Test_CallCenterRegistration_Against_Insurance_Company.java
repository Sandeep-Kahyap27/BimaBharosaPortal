...
public class Test_CallCenterRegistration_Against_Insurance_Company extends MainClass {
    ...
    public void test_callCenter_registration_against_insurance_company(String identifyBy, String mob, String pinCode, String compAgainst, String insCompany, String policyType, String complaintType, String complaintDescType, String policyNumber, String complaintDetails, String source, String priority, String TAT, String priority_handling_details, String remarks) throws IOException, InterruptedException {
        ...
        if(msg != null && msg.equals("Complaint Registered Successfully.")){
            test.log(Status.PASS, "Complaint registered Against Insurance company on behalf of policy holder");
            logger.info("Test Passed : Complaint registered Against Insurance company on behalf of policy holder");
        }
        else{
