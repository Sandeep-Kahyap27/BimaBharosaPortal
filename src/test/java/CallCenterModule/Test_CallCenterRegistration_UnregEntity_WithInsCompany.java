...
public class Test_CallCenterRegistration_UnregEntity_WithInsCompany extends MainClass {
    ...
    public void test_callCenter_registration_against_unregisteredEntity_with_insCompany(String identifyBy, String mob, String pinCode, String compAgainst, String insCompany, String policyType, String complaintType, String complaintDescType, String unReg_companyName, String address, String phone, String description, String type_of_svc, String contact_person_name, String policyNumber, String complaintDetails, String source) throws IOException, InterruptedException {
        ...
        if(msg != null && msg.equals("Complaint Registered Successfully.")){
            test.log(Status.PASS, "Complaint registered Against Unregistered entity with insurance company");
            logger.info("Test Passed : Complaint registered Against Unregistered entity with insurance company");
        }
        else{
