...
public class Test_CallCenterRegistration_DefaultTATDays extends MainClass {

    @Test(dataProvider = "Call_Center_Register", dataProviderClass = DataReader.class)
    public void test_callCenter_registration_defaultTATDays(String identifyBy, String mob, String pinCode, String compAgainst, String insCompany, String policyType, String complaintType, String complaintDescType, String policyNumber, String complaintDetails, String source, String priority, String TAT, String priority_handling_details, String remarks) throws IOException, InterruptedException {

        test = extent.createTest("Positive: Verify call center user is able to register complaint for VIP policy holder with Default TAT Days");
        ...
        if(msg != null && msg.equals("Complaint Registered Successfully.")){
            test.log(Status.PASS, "Complaint registered for VIP policy holder with default TAT Days");
            logger.info("Test Passed : Complaint registered for VIP policy holder with default TAT Days");
        }
        else{
