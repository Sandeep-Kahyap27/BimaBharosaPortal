...
public class Test_CallCenterRegistration_NewPolicyHolder extends MainClass {

    @Test(dataProvider = "Call_Center_NewUser", dataProviderClass = DataReader.class)
    public void test_callCenter_registration_newPolicyHolder(String complaint_name, String mobile_number, String email, String pinCode, String compAgainst, String insCompany, String policyType, String complaintType, String complaintDescType, String policyNumber, String complaintDetails, String source, String priority, String TAT, String priority_handling_details, String remarks) throws IOException, InterruptedException {

        test = extent.createTest("Positive: Verify call center user is able to register complaint for new policy holder");
        loadURL("LoginURL");
        ...
        if(msg != null && msg.equals("Complaint Registered Successfully.")){
            test.log(Status.PASS, "Complaint registered for New policy holder");
            logger.info("Test Passed : Complaint registered for New policy holder");
        }
        else{
