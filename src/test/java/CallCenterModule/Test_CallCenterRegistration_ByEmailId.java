...
public class Test_CallCenterRegistration_ByEmailId extends MainClass {

    @Test(dataProvider = "Call_Center_Register_EmailId", dataProviderClass = DataReader.class)
    public void test_callCenter_registration_emailId(String identifyBy, String emailId, String pinCode, String compAgainst, String insCompany, String policyType, String complaintType, String complaintDescType, String policyNumber, String complaintDetails, String source) throws IOException, InterruptedException {

        test = extent.createTest("Positive: Verify call center user is able to register complaint by email Id");
        ...
        cr.enterMobileNumberOrEmail(emailId);
        cr.search();
        ...
        if(msg != null && msg.equals("Complaint Registered Successfully.")){
            test.log(Status.PASS, "Complaint registered by email Id on behalf of policy holder");
            logger.info("Test Passed : Complaint registered by email Id on behalf of policy holder");
        }
        else{
